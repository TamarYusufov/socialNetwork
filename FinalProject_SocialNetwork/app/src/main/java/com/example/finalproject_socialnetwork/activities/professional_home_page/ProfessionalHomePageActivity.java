...
import com.example.finalproject_socialnetwork.activities.pet_owner_home_page.PetOwnerProfileTabFragment;
...
public class ProfessionalHomePageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_professional_home_page);
        ...
        FirebaseUtils.getCurrentUserDetails(FirebaseAuth.getInstance().getUid(),true,
                new FirebaseUtils.UserDetailsCallback() {
                    ...
                    public void onSuccessProfessional(Professional professional) {
                        String WelcomeUserName = "Welcome "+ professional.getName();
                        welcomeTextView.setText(WelcomeUserName);
                    }
                    @Override
                    public void onFailure(String errorMessage) {
                        Toast.makeText(ProfessionalHomePageActivity.this,
    ...
    private void initTabLayoutAndViewPager() {
        viewPager.setAdapter(new ProfessionalHomePageActivity.ViewPageAdapter(this));
                ...
                .addOnCompleteListener(task -> {
                    if(task.isSuccessful()) {
                        Toast.makeText(ProfessionalHomePageActivity.this,
                                ...
                                Toast.LENGTH_LONG).show();
                        ((ViewPageAdapter)viewPager.getAdapter()).getLastProfessionalProfileTabFragment()
    ...
    private static class ViewPageAdapter extends FragmentStateAdapter {
        private ProfessionalProfileTabFragment lastProfessionalProfileTabFragment;
        ...
        public Fragment createFragment(int position) {
            switch (position) {
                ...
                case 1:
                    lastProfessionalProfileTabFragment = new ProfessionalProfileTabFragment();
                    return lastProfessionalProfileTabFragment;
                case 2:
                default:
                    return new ProfessionalHomePageMainTabFragment(); // TODO delete?
            }
        }

        public ProfessionalProfileTabFragment getLastProfessionalProfileTabFragment() {
            return lastProfessionalProfileTabFragment;
        }
